namespace File_Compression
{
    partial class Compress
    {
        ...
        private void InitializeComponent()
        {
			...
			this.txtupload.Size = new System.Drawing.Size(276, 23);
			this.txtupload.TabIndex = 6;
			this.txtupload.TextChanged += new System.EventHandler(this.txtupload_TextChanged);
			// 
			// back1
			// 
			...
			this.ucompress.Click += new System.EventHandler(this.ucompress_Click);
			// 
			// Compress
			// 
